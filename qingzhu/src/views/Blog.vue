        ...
        <div class="s_info">
          <ul class="left">
            <li>
              <div class="show">
                <a href="#">
                  <img src="@/assets/Home/images/s.jpeg" alt />
                </a>
              </div>
              <div class="data">
                <div class="nickname">
            ...
            <li>
              <div class="show">
                <a href="#">
                  <img src="@/assets/Home/images/g.jpeg" alt />
                </a>
              </div>
              <div class="data">
                <div class="nickname">
              ...
              <div class="show">
                <a href="#">
                  <div class="art">
                    ...
                    <p
                      class="sub"
                    >欢迎使用友好速搭，你看到的这个版块是轻博客功能，它能让你更好地展示和传播你的理念。现在简单介绍下这个功能，你可以新建4种轻博客内容：文字博客图片博客音乐博客视频博客友好速搭轻博客作为独立网站的功能之一，它将是实现你轻流量入口的重要一步。我们意在为你营造一个温暖的氛围，和冷冰冰的电商说再见。在做优雅有温度的生意的同时，写下你的故事，分享你的心情。让店铺中的每一件商品都赋有鲜活的生命力。将你的故事心情、优美的图片、有共鸣的音乐以及心动的视频随时随地分享至微博或朋友圈等平台，会有更多的人看到你和你独立</p>
                  </div>
                </a>
              </div>
              <div class="data">
...
@import "../assets/Home/css/blog.css";
