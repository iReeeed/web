...
<!-- header部分开始 -->
	...
	<div class="banner">
		<ul class="pic">
			<li class = "cur"><a href="#"><img src="@/assets/Home/images/img11.png" alt=""></a></li>
			<li><a href="#"><img src="@/assets/Home/images/img12.png" alt=""></a></li>
			<li><a href="#"><img src="@/assets/Home/images/img13.png" alt=""></a></li>
		</ul>
		<ol class = "circle">
			<li class = "cur"></li>
			<li></li>
	...
	<div class="qingzhu_content">
		<div class="qingzhu_content_c inner_c">
				...
				<div class="pro_pic">
					<div class="pro_c">
						<ul>
							<li>
								<a href="#">
									<img src="@/assets/Home/images/img23.png" alt="">
									<div class="cont">
										<h3>黑陶自然花香蜡烛</h3>
										 <span>￥300</span>
									</div>
							...
							<li>
								<a href="#">
									<img src="@/assets/Home/images/img24.png" alt="">
									<div class="cont">
										<h3>黑陶自然花香蜡烛</h3>
										 <span>￥300</span>
									</div>
			...
			<div class="pro2">
				...
				<div class="pro2_c">
					<ul class = "pro2_c_pic">
						<li class = "pic1 pic">
							<a href="#">
								<img src="@/assets/Home/images/img31.jpg" alt="">
							</a>
							<span></span>
						</li>
						<li class = "pic2 pic">
							<a href="#">
								<img src="@/assets/Home/images/img32.jpg" alt="">
							</a>
							<span></span>
						</li>
						<li class = "pic3 pic">
							<a href="#">
								<img src="@/assets/Home/images/img33.jpg" alt="">
							</a>
							<span></span>
						</li>
					</ul>
			...
			<div class="pro3">
				...
				<div class="pro3_c">
					<ul  class = "pub_pro">
						<li>
							<a href="#">
								<img src="@/assets/Home/images/img40.jpg" alt="">
							</a>
							<div class="mask"></div>
						</li>
						<li>
					...
					<ul  class = "pub_pro">
						<li>
							<a href="#">
								<img src="@/assets/Home/images/img45.jpg" alt="">
							</a>
							<div class="mask">
							</div>
						</li>
			...
			<div class="pro4">
				...
				<div class="por4_top">
					<div class="pic1 pic">
						<img src="@/assets/Home/images/img51.jpg" alt="">
						<span></span>
					</div>
					<div class="pic2">
						<div class="top pic">
							<img src="@/assets/Home/images/img52.jpg" alt="">
							<span></span>
						</div>
						<div class="bottom pic">
							<img src="@/assets/Home/images/img53.jpg" alt="">
							<span></span>
						</div>
					</div>
					<div class="pic3 pic">
						<img src="@/assets/Home/images/img54.jpg" alt="">
						<span></span>
					</div>
				</div>
				<div class="pro4_bottom">
					<ul class="pro4_c">
						<li>
							<div class="pic">
								<a href="#">
									<img src="@/assets/Home/images/img55.png" alt="">
								</a>
							</div>
							<p class="cont">
								<a href="#">
						...
						<li>
							<div class="pic">
								<a href="#">
									<img src="@/assets/Home/images/img56.png" alt="">
								</a>
							</div>
							<p class="cont">
								<a href="#">
						...
						<li>
							<div class="pic">
								<a href="#">
									<img src="@/assets/Home/images/img57.png" alt="">
								</a>
							</div>
							<p class="cont">
								<a href="#">
						...
						<li>
							<div class="pic">
								<a href="#">
									<img src="@/assets/Home/images/img58.png" alt="">
								</a>
							</div>
							<p class="cont">
								<a href="#">
						...
						<li>
							<div class="pic">
								<a href="#">
									<img src="@/assets/Home/images/img59.png" alt="">
								</a>
							</div>
							<p class="cont">
								<a href="#">
		...
		<div class="liangpin_c inner_c">
			...
			<div class="lp_pro">
				<ul>
					<li>
						<a href="#" title="">
							<img src="@/assets/Home/images/img61.png" alt="">
						</a>
						<div class="cont">
							<div class="tit">
								<h4>天草陶石咖啡杯套装</h4>
					...
					<li>
						<a href="#" title="">
							<img src="@/assets/Home/images/img62.png" alt="">
						</a>
						<div class="cont">
							<div class="tit">
								<h4>天草陶石咖啡杯套装</h4>
					...
					<li>
						<a href="#" title="">
							<img src="@/assets/Home/images/img63.png" alt="">
						</a>
						<div class="cont">
							<div class="tit">
								<h4>天草陶石咖啡杯套装</h4>
					...
					<li>
						<a href="#" title="">
							<img src="@/assets/Home/images/img64.png" alt="">
						</a>
						<div class="cont">
							<div class="tit">
								<h4>天草陶石咖啡杯套装</h4>
 ...
 <script src="@/assets/Home/js/青竹1.js"></script>
    ...
    <script src="@/assets/Home/js/查看所有类别.js"></script>
